...
export const TRAVEL = Symbol('travel');
export const TRAVEL_TO = Symbol('travel to');

export const ITEM_MULTI_USE = Symbol('item multi-use');
export const ITEM_SINGLE_USE = Symbol('item single-use');
